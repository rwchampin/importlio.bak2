export const SimpleDropdown = ({ options, onChange, value, label }) => {

    return (
        <div x-data="{ isOpen: true }" className="relative inline-block">

    <button @click="isOpen = !isOpen" className="relative z-10 block p-2 text-gray-700 bg-white border border-transparent rounded-md dark:text-white focus:border-blue-500 focus:ring-opacity-40 dark:focus:ring-opacity-40 focus:ring-blue-300 dark:focus:ring-blue-400 focus:ring dark:bg-gray-800 focus:outline-none">
