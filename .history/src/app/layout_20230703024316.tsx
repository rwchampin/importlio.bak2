...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="antialiased bg-pink-500">
        <SupabaseProvider>
          {/* @ts-expect-error */}
          <Navbar />
          <main className="bg-green-400 flex w-full h-auto flex-auto min-h-[calc(100dvh-4rem)] md:min-h[calc(100dvh-5rem)] p-[20px] gap-[20px]">
            {children}
          </main>
          <Footer />
        </SupabaseProvider>
