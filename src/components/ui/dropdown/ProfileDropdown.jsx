...
export default function ProfileDropdown({ children, user, signOut }) {
  const [open, setOpen] = useState(false);

  useEffect(() => {
    gsap.set('.profile-dropdown', {
        opacity: 0,
        scale: 0.5,
        display: 'none',
        zIndex: -1
  ...
  return (
    <div className="relative inline-block">
      ...
      <div
        ...
        className="profile-dropdown absolute right-0 w-56 py-2 mt-2 overflow-hidden origin-top-right bg-white rounded-md shadow-xl dark:bg-gray-800"
      >
        <a
          href="#"
        ...
        >
          <img
            ...
            src={user.image}
            alt="Shopify Affilliate Product Import App | Importlio"
          />
          <div className="mx-1">
